    ...
    return (
        <div>
			...
			<div className="min-w-[162px] w-[162px] flex flex-col justify-center gap-2">
				<div className="bg-[#6A6C77] hover:bg-neutral-500 hover:cursor-pointer h-8 flex gap-1 collapse justify-center items-center text-white text-sm" onClick={toggleReviewForm}>
