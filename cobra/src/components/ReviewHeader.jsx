	...
	return (
        <div className="flex py-5 m-auto max-w-[75%] h-[158px] border-t-[1px] border-slate-300">
			...
			<div className="min-w-[162px] w-[162px] flex flex-col justify-center gap-2">
				<div className="bg-[#6A6C77] hover:bg-neutral-500 hover:cursor-pointer h-8 flex gap-1 justify-center items-center text-white text-sm" onClick={handlePlaceholder1}>
                ...
                <div className="bg-[#6A6C77] hover:bg-neutral-500 hover:cursor-pointer h-8 flex gap-1 justify-center items-center text-white text-sm" onClick={handlePlaceholder2}>
