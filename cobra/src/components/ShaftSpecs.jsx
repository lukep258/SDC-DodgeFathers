    ...
    return (
      <div className="mx-12 py-8" >
        <div className="border-b mb-7">
            <a><h1 className="text-3xl cursor-pointer hover:text-blue-700 hover:underline">SHAFT SPECS</h1></a>
        </div>
        
  
        <h3 className="text-lg font-bold mb-2">Project X HZRDUS Gen 4 Black</h3>
        ...
        <div className="table-container overflow-x-auto">
            ...
            <thead className="bg-gray-100 uppercase text-slate-900 text-sm tracking-tight ">
