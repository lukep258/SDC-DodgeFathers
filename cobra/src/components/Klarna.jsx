...
return(
  ...
  close
    ...
    <div className='flex flex-col justify-center items-center bg-yellow-400 w-3/12 mx-auto'>
        ...
        <div className='h-16 w-[460px] bg-gray-400 flex flex-row justify-between items-center px-4 rounded-xl mb-4'>
        ...
        <div className='h-16 w-[460px] bg-gray-400 flex flex-row justify-between items-center px-20 mb-4'>
