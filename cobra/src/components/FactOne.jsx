...
const FactOne = () => {
    return (
        ...
        <div className="hero custom-hero font-titillium" style={{backgroundImage: 'url(http://images.salsify.com/image/upload/s--35mrsC77--/7b8cc3ac2424f7186070c5e491b2b761bf5eb250.jpg)'}}>
            <div className="hero-content-wrapper">
                <div className="hero-content" style={{width: '80%', padding: '0 100px'}}>
